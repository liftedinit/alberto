...
describe("home page", () => {
  ...
  it("should show asset details and transactions", async () => {
    ...
    expect(firstTxn.getByText(/05/i)).toBeInTheDocument()
    expect(firstTxn.getByText(/09/i)).toBeInTheDocument()
    ...
    expect(secondTxn.getByText(/04/i)).toBeInTheDocument()
    expect(secondTxn.getByText(/09/i)).toBeInTheDocument()
  ...
  it("should show list of account transaction history", async () => {
    ...
    expect(screen.getByText(/09/i)).toBeInTheDocument()
