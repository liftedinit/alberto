...
describe("reviver", () => {
    it("should work with golden data (backward compatible)", async () => {
        ...
        const webauthn = {
            "dataType": "c",
            "rawId": "Zv3c95lE/tNOOr4qndQb5DhNO3V2T8dImaD1EbwqmMf7XsnI7Iw2NPaw7PP7aj56nixK5YTLxXNxFwDRfZumxQ==",
        ...
        expect(address.toString()).toEqual("mahgrwinlmcbpl6pglk34hwfruvikyu4wooba2xol3yqns5qhp");
